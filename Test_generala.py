...
class CalcularPuntosTest(unittest.TestCase):
    ...
    def test_calcular_puntos_full_puntos_30_lanzamiento_2_0(self):
        dados = [3,3,6,6,6]
        numero_lanzamiento = 2
        puntos = calcular_puntos(numero_lanzamiento, dados, "full")
        self.assertEqual(puntos, 30)

    def test_calcular_puntos_full_puntos_30_lanzamiento_2_1(self):
        dados = [3,6,3,6,6]
        numero_lanzamiento = 2
        puntos = calcular_puntos(numero_lanzamiento, dados, "full")
        self.assertEqual(puntos, 30)

    def test_calcular_puntos_full_puntos_30_lanzamiento_3(self):
        dados = [1,2,1,1,2]
        numero_lanzamiento = 3
        puntos = calcular_puntos(numero_lanzamiento, dados, "full")
        self.assertEqual(puntos, 30)

    def test_calcular_puntos_full_puntos_30_3(self):
        dados = [4,5,5,5,4]
        numero_lanzamiento = 2
        puntos = calcular_puntos(numero_lanzamiento, dados, "full")
        self.assertEqual(puntos, 30)

    def test_calcular_puntos_full_servido_puntos_35(self):
        dados = [3,3,6,6,6]
        numero_lanzamiento = 1
        puntos = calcular_puntos(numero_lanzamiento,dados,"full")
    ...
    def test_calcular_escalera_menor_lanzamiento_2(self):
        dados = [4, 1, 2, 3, 5]
        numero_lanzamiento = 2
        puntos = calcular_puntos(numero_lanzamiento, dados, "escalera")
        self.assertEqual(puntos, 20)

    def test_calcular_escalera_menor_lanzamiento_3(self):
        dados = [5, 1, 2, 3, 4]
        numero_lanzamiento = 3
        puntos = calcular_puntos(numero_lanzamiento, dados, "escalera")
        self.assertEqual(puntos, 20)

    def test_calcular_escalera_menor_servida(self):
        dados = [4, 1, 2, 3, 5]
        numero_lanzamiento = 1
        puntos = calcular_puntos(numero_lanzamiento, dados, "escalera")
        self.assertEqual(puntos, 25)

    def test_calcular_escalera_mayor_lanzamiento_2(self):
        dados = [2, 3, 4, 5, 6]
        numero_lanzamiento = 2
        puntos = calcular_puntos(numero_lanzamiento, dados, "escalera")
        self.assertEqual(puntos, 20)

    def test_calcular_escalera_mayor_lanzamiento_3(self):
        dados = [2, 3, 4, 5, 6]
        numero_lanzamiento = 3
        puntos = calcular_puntos(numero_lanzamiento, dados, "escalera")
        self.assertEqual(puntos, 20)
